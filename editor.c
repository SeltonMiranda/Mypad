...
void delete_char(editor *editor) {
        ...
        // Verifica se deve deletar a linha inteira

        //if (current->len == 1 && editor->cx == 1) {

        //        if (prev == NULL) {

        //                // Se a linha a ser deletada for a primeira linha

        //                editor->head = current->next;

        //        } else {

        //                // Remover a linha atual do meio
        ...
        //        // Ajustar as coordenadas do cursor

        //        if (editor->current_row >= editor->num_rows) {

        //                editor->current_row = editor->num_rows - 1;

        //        }



        //        editor->cx = (prev != NULL) ? prev->len : 0;

        //        editor->cy = editor->current_row;
